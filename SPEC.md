...
- Formuário para envio de atestados e justificativas.
...
1. **Não codifique se houver dúvidas**: Caso ocorra ambiguidades ou indefinições nos requisitos de interface ou integrações, pare a execução, elabore os questionamentos específicos e consulte o usuário ou a documentação antes de realizar alterações no código.
